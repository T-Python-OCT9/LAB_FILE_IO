...
def to_do_list(user_input: str)->str:
    ...
    if user_input == "y":
        ...
        if user_ask_no == "y":
            ...
            print("Type exit to exit the program or ", to_do_list())
    elif user_input == "exit":
        print("thank you for using the To-Do program, come back again soon")   
    else:
        print("Wrong entry! Type y for Yes and n for No, and exit to close the program ")
        return to_do_list()

user_input = input("Do you want to add a new To-Do item? ")
to_do_list(user_input)
